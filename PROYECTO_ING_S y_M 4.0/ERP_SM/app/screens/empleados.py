...
"""
    ...
    def crear_item(self, emp):
        ...
        fila.add_widget(Label(text=emp[1]))  # nombre
        fila.add_widget(Label(text=emp[2]))  # apellido
        fila.add_widget(Label(text=emp[3]))  # cedula
        fila.add_widget(Label(text=f"${emp[8]}"))  # salario_base

        btn_editar = Button(text="Editar", size_hint_x=None, width=90)
        btn_eliminar = Button(text="Eliminar", size_hint_x=None, width=90)
